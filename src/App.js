  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <ChartCard title="Daily Costs" endpoint={`${API_BASE_URL}/api/chart/daily-costs`} />
        <ChartCard title="Block Utilization" endpoint={`${API_BASE_URL}/api/chart/block-utilization`} />
      </div>
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      {results.recommended_transfers.map((t) => (
                        <tr key={t.block_id}>
                          ...
                          <td className="px-4 py-2 text-sm text-gray-500">
                            ${t.expected_savings_30d.toLocaleString(undefined, {maximumFractionDigits:2})}
                          </td>
                          <td className="px-4 py-2 text-sm text-gray-500">
